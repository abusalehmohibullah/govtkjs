...
watch(() => {
    confirmingSectionDeletion.value = props.show;
});

const deleteSection = async () => {
    try {
        // Send a DELETE request to delete the section
        form.delete(route('admin.sections.destroy', props.section.id), {
            errorBag: 'deleteSection',
        });
...
<template>
    ...
    <ConfirmationModal :show="confirmingSectionDeletion" :max-width="maxWidth" :closeable="closeable" @close="close">
