...
<template>
                        ...
                        <div class="w-full rounded bg-white border shadow-sm position-relative">
                            ...
                            <div class="relative">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item text-red-700 hover:bg-red-700 hover:text-white" @click="() => toggleModal(media)">Delete</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <DeleteMediaForm :show="showModal" :media="selectedMedia" @close="toggleModal" />
    <div class="mt-5">
