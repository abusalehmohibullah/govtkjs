                ...
                <div class="row col-md-12 col-lg-6">
                    ...
                    <div class="col-8 col-lg-8">
                        ...
                        <div class="follow">
                            ...
                            <div class="icon">
                                <a class="btn p-1" href="{{ config('informations.facebook') }}"><i
                                        class="footer-link fa-brands fa-facebook-f"></i></a>
                                <a class="btn p-1" href="{{ config('informations.instagram') }}"><i
                                        class="footer-link fa-brands fa-instagram"></i></a>
                                <a class="btn p-1" href="{{ config('informations.x') }}"><i
                                        class="footer-link fa-brands fa-x-twitter"></i></a>
                                <a class="btn p-1" href="{{ config('informations.linkedin') }}"><i
                                        class="footer-link fa-brands fa-linkedin-in"></i></a>
                                <a class="btn p-1" href="{{ config('informations.youtube') }}"><i
